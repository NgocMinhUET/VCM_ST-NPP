...
from src.models.stnpp import STNPP
...
def train_joint(args):
    ...
    if args.use_real_codec:
        ...
        proxy_model = ProxyNetwork()  # Initialize model architecture
